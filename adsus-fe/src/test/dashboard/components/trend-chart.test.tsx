...
function buildPoint(overrides: Partial<DailyPoint>): DailyPoint {
  return { date: "2026-07-01", newAccounts: 0, cases: 0, appointments: 0, revenue: 0, profit: 0, ...overrides };
}
...
describe("TrendChart", () => {
  ...
  it("measure 'revenue' — render biểu đồ có nhãn Doanh thu", () => {
    const points: DailyPoint[] = [
      { date: "2026-07-01", newAccounts: 0, cases: 0, appointments: 0, revenue: 500000, profit: 300000 },
      { date: "2026-07-02", newAccounts: 0, cases: 0, appointments: 0, revenue: 300000, profit: 200000 },
    ];
  ...
  it("measure 'profit' — render biểu đồ có nhãn Tiền lãi", () => {
    const points: DailyPoint[] = [
      { date: "2026-07-01", newAccounts: 0, cases: 0, appointments: 0, revenue: 500000, profit: 300000 },
      { date: "2026-07-02", newAccounts: 0, cases: 0, appointments: 0, revenue: 300000, profit: 200000 },
    ];

    render(<TrendChart points={points} measure="profit" label="Tiền lãi" />);
