            ...
            {filteredOptions.length === 0 ? (
              ...
              filteredOptions.map((option) => (
                <div
                  ...
                  tabIndex={0}
                  className={cn(
                    "relative flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none transition-colors hover:bg-[var(--success)] hover:text-white data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
                    value === option.value && "bg-[var(--success)] text-white"
                  )}
                  onClick={() => {
