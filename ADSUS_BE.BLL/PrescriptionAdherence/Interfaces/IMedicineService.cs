...
public interface IMedicineService
{
    ...
    Task<PagedResult<MedicineResponse>> GetPagedAsync(int page, int pageSize, string? keyword, bool? inStock = null, string? status = null, CancellationToken ct = default);
    Task<MedicineResponse?> GetByIdAsync(Guid id, CancellationToken ct = default);
