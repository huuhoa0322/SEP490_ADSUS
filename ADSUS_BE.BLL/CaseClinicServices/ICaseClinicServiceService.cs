...
public interface ICaseClinicServiceService
{
    ...
    Task<CaseClinicServiceResponse> AddServiceToCaseAsync(Guid caseId, Guid clinicServiceId, Guid actingDoctorId, CancellationToken ct = default);
    ...
    Task RemoveServiceFromCaseAsync(Guid caseId, Guid caseClinicServiceId, Guid actingDoctorId, CancellationToken ct = default);
}
