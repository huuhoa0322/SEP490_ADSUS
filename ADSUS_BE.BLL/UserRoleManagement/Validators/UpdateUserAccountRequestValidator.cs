...
public class UpdateUserAccountRequestValidator : AbstractValidator<UpdateUserAccountRequest>
{
    ...
    /// </summary>
    private static readonly string[] AllowedRoles = { "ADMIN", "DOCTOR", "STAFF", "PATIENT", "PHARMACIST" };
    ...
    public UpdateUserAccountRequestValidator()
    {
        ...
        RuleFor(x => x.Role)
            ...
            .WithMessage("Role must be one of ADMIN, DOCTOR, STAFF, PATIENT or PHARMACIST.");
